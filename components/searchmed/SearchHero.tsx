    ...
    <section id="search" className="bg-gradient-to-r from-[#F6F9FC] to-[#EEF2F7] py-16 font-sans">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="md:relative md:right-25 w-full md:min-w-[1032px] mx-auto bg-white rounded-2xl border border-[#E2E8F0] px-6 py-8 shadow-sm">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[13px] font-semibold text-[#2B3A4F]">
                Medicine name
              </label>
              <input
                type="text"
              ...
              <p className="text-[12px] text-[#7C8A9B]">
                You can include strength or form if you know it, such as 20 mg
                tablet.
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-col gap-2">
              <span className="text-[13px] font-semibold text-[#2B3A4F]">
                Search radius
              </span>
            ...
            <button className="border border-[#13A594] w-full md:w-[650px] flex items-center justify-center gap-2 bg-[#13A594] hover:bg-[#128f81] cursor-pointer text-white font-semibold text-[14px] px-5 md:px-7 py-4 rounded-lg transition-colors duration-150">
              {" "}
              <svg
                width="16"
                height="16"
          ...
          <div className="flex items-start gap-2">
            ...
            <p className="text-[13px] text-[#566476] leading-relaxed">
              Availability is a signal, not a guarantee. Confirm directly with
              the pharmacy before traveling.
            </p>
          </div>
        </div>
        ...
        <p
          ...
          className="cursor-pointer text-center mt-5 text-[14.4px] text-[#13A594] font-medium cursor-pointer"
        >
