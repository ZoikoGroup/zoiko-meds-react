...
const ROWS: { area: string; cells: [Level, Level, Level, Level, Level] }[] = [
  {
    area: "Availability intelligence",
    cells: ["full", "scoped", "view", "view", "scoped"],
  },
  {
    area: "Pharmacy workflows",
    cells: ["full", "full", "none", "review", "none"],
  },
  {
    area: "Reports & exports",
    cells: ["full", "scoped", "view", "full", "scoped"],
  },
  { area: "Admin & settings", cells: ["full", "org", "none", "none", "none"] },
  { area: "Audit logs", cells: ["full", "org", "none", "full", "none"] },
  {
    area: "API & integrations",
    cells: ["full", "none", "none", "review", "full"],
  },
];
              ...
              <table className="w-full min-w-[760px] border-collapse">
                ...
                <tbody>
                  {ROWS.map((row, ri) => (
                    ...
                    >
                      <td
                        className="px-6 py-4 text-[13px] font-bold sm:px-8"
                        style={{ color: NAVY }}
                      >
                        {row.area}
                      </td>
  ...
  return (
    <div
      style={{
        ...
        animation: active
          ? `securityAccessFadeUp 0.6s ease-out ${index * 90}ms both`
          : "none",
      }}
    >
      {children}
