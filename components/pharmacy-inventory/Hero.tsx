                ...
                <div className="grid items-center gap-6 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                            <button
                            onClick={()=>router.push("#join-pharmacy-network")} className=" cursor-pointer rounded-xl bg-[#13A594] border border-[#13A594] px-6 cursor-pointer py-3 font-semibold text-white transition hover:bg-[#119485]">
