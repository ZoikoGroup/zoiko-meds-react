            ...
            <div className="bg-white border w-full lg:w-[360px] border-[#C4C6CE] rounded-2xl shadow-sm p-4">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li
                    key={loc.text}
                    className="flex items-center gap-2 text-sm text-[#44474D]"
                  >
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base font-semibold text-[#081B33]">
                        {card.labelName}
                      </p>
                      {card.note && (
                        <p className="text-xs text-[#566476] italic">
                          {card.note}
                        </p>
                      )}
                    </div>
