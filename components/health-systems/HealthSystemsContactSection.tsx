  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(internalApi("health-systems"), {
        ...
        body: JSON.stringify({
          briefingType: "Health System Briefing",
              ...
              >
                <div className="flex flex-col items-center justify-center text-center">
                  ...
                  <h4 className="mt-2 text-[15px] font-bold text-[#00786F]">
                    Health System Briefing Request Submitted
                  </h4>
                  <p className="mt-1 text-[13px] leading-relaxed text-[#056059]">
                    Thank you! Your health system briefing request has been received. Our team will contact you soon.
                  </p>
                </div>
              </div>
            )}
