...
export default function HospitalSystemsFinalCtaSection() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#0F1F4E] py-16 sm:py-20 lg:py-24">
        ...
        >
          ...
          <Reveal index={0} active={mounted}>
            <h2 className="text-[1.9rem] font-extrabold leading-tight sm:text-[2.1rem]">
              <span className="text-white">Give your health system a clearer view of </span>
              <span style={{ color: ACCENT }}>medicine availability risk.</span>
            </h2>
          </Reveal>
          ...
          <Reveal index={1} active={mounted}>
            <p className="mt-4 max-w-xl text-[14.5px] leading-relaxed" style={{ color: "#9AA3C0" }}>
              Request an enterprise briefing to see how ZoikoMeds supports availability signals,
              shortage risk, pharmacy network activity, and compliance-conscious reporting
              across facilities.
            </p>
          </Reveal>
          ...
          <Reveal index={3} active={mounted}>
            <p className="mt-8 max-w-xl text-[12px] leading-relaxed" style={{ color: "#6C77A0" }}>
              ...
              provide medical advice or expose exact inventory quantities to unauthorized users.
            </p>
          </Reveal>
        </div>
      </div>
  ...
  return (
    <div
      style={{
        ...
        animation: active ? `hospitalSystemsFinalCtaFadeUp 0.6s ease-out ${index * 90}ms both` : "none",
      }}
    >
      {children}
      <style>{`
        @keyframes hospitalSystemsFinalCtaFadeUp {
