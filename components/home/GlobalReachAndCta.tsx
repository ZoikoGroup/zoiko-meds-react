        ...
        >
          ...
          <div className="relative flex flex-col lg:flex-row items-center lg:items-stretch gap-0">
            ...
            <div className="flex-1 px-8 sm:px-12 py-12 lg:py-16 flex flex-col justify-center">
              ...
              {/* headline */}
              <h2
                className={`text-3xl sm:text-4xl lg:text-[2.4rem] font-extrabold text-white leading-tight mb-4
              ...
              {/* text links */}
              <div
                className={`flex flex-wrap gap-x-5 gap-y-2 mb-8 ${isVisible ? "cta-in" : "opacity-0"}`}
