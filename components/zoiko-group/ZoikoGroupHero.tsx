...
const structure: StructureItem[] = [
  {
    ...
    desc: "Group direction & governance",
    tag: "PARENT",
  },
  {
    name: "Zoiko Healthcare Inc.",
    desc: "Healthcare operating company",
    tag: "OPERATING",
  },
  {
    name: "ZoikoMeds",
    desc: "Medicine availability infrastructure",
    tag: "PLATFORM",
    highlighted: true,
  },
  {
    name: "Zoiko Tech Inc.",
    desc: "Technology enablement (where assigned)",
    tag: "SUPPORT",
  },
];
    ...
    <section className="bg-linear-to-b from-slate-50 px-5 sm:px-8 lg:px-54 to-slate-100 py-16">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 lg:gap-30 lg:grid-cols-2 lg:items-start">
        ...
        <div>
          <div
            style={fadeUp(0)}
            className="text-xs flex gap-3 leading-4 tracking-[0.45px] text-[#566476]"
          >
          ...
          <p
            style={fadeUp(0.05)}
            className="mt-5 text-xs font-semibold tracking-widest text-[#13A594]"
          >
            ZOIKO GROUP
          </p>
          ...
          <h1
            style={fadeUp(0.1)}
            className="mt-3 text-3xl leading-tight font-bold tracking-[-0.8px] text-[#0D1B2E] md:text-[40px] lg:min-w-[550px] lg:leading-12"
          >
          ...
          <p
            style={fadeUp(0.2)}
            className="mt-4 text-[#566476] lg:min-w-[580px]"
          >
            Zoiko Group supports ZoikoMeds and Zoiko Healthcare Inc with
            strategic direction, governance standards, and ecosystem
            infrastructure for trusted medicine availability access.
          </p>

          <div
            style={fadeUp(0.3)}
            className="mt-8 flex flex-col sm:flex-row gap-4 lg:min-w-[580px]"
          >
            <button
          ...
          <p
            style={fadeUp(0.5)}
            className="mt-4 flex max-w-[450px] items-start gap-2 text-sm leading-6 text-[#566476]"
          >
            <img
              src="/zoiko-group/view.png"
              alt="image"
              height={15}
              width={15}
            />
            <span>
              ZoikoMeds is a governed platform operated by Zoiko Healthcare Inc,
              a subsidiary of Zoiko Group Inc. ZoikoMeds is not a pharmacy and
              does not prescribe, dispense, sell, deliver, reserve, recommend,
