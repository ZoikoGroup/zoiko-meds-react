                ...
                <Reveal index={4}>
                  <div className="mt-2 flex flex-col gap-3 sm:flex-row">
                    ...
                    >
                      ...
                      <span className="relative">Contact Media Team</span>
                    </button>
...
function HeroImage() {
  return (
    <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl bg-[#0B1530] shadow-[0_20px_48px_-16px_rgba(15,31,78,0.24)] transition-shadow duration-300 hover:shadow-[0_24px_56px_-16px_rgba(15,31,78,0.30)] sm:aspect-[5/4]">
      {/* TODO: Replace src with the final press hero image/illustration URL */}
      <img
        src="/images/press-hero.webp"
        alt="ZoikoMeds medicine availability infrastructure illustration"
