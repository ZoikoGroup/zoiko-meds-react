      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        ...
        <div>
          {mounted ? (
            <div className="flex flex-col gap-5">
              ...
              <Reveal index={1}>
                <h1 className="font-[var(--font-plus-jakarta-sans)] text-4xl font-bold leading-[1.15] text-[#0F1F4E] sm:text-[40px]">
              ...
              <Reveal index={2}>
                <p className="max-w-lg text-[15px] leading-relaxed text-[#5B6478]">
                  ...
                  structured way to respond to availability inquiries, reduce
                  repetitive calls, and help patients know what to confirm next
                  — without exposing exact public stock or promising dispensing.
                </p>
              </Reveal>
              ...
              <Reveal index={5}>
                <p className="mt-1 flex max-w-lg items-start gap-2.5 text-[12.5px] leading-relaxed text-[#8891A4]">
                  ...
                  A confirmation response is informational. It does not reserve
                  medicine, guarantee stock, approve dispensing, validate
                  prescriptions, or replace pharmacist judgment.
                </p>
              </Reveal>
            </div>
          ) : (
        ...
        <div className="flex justify-center lg:justify-end">
          {mounted ? (
            <Reveal index={3}>
              <img
                src="/confirmation/hero.png"
                alt="Confirmation Requests Control Interface"
