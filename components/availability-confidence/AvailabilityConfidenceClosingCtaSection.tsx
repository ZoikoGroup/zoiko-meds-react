              ...
              <>
                ...
                <Reveal index={1}>
                  <p className="mx-auto mt-4 max-w-md text-[14px] leading-relaxed text-white/50">
                    Search medicine availability signals near you, then confirm directly
with the pharmacy before traveling.
                ...
                <Reveal index={2}>
                  <div className="mt-7 flex flex-col items-center justify-center gap-3 sm:flex-row">
                    ...
                    >
                      <span className="absolute inset-0 -translate-x-full text-white bg-white/25 transition-transform duration-500 ease-out group-hover:translate-x-full" />
                      <span className="relative">Search Medicines</span>
                    </button>
