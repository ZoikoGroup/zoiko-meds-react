...
const TRUST_POINTS = [
  {
    ...
    description: "ZoikoMeds does not sell, prescribe, dispense, or deliver medicine.",
    icon: (
      <path
  ...
  },
  {
    ...
    description:
      "The portal supports medicine organization and availability alerts. It does not provide diagnosis, treatment, prescribing, or substitution guidance.",
    icon: (
      <path
  ...
  {
    id: "privacy-aware-controls",
    title: "Privacy-aware account controls",
    description:
      "Manage communication preferences, consent choices, and account security settings.",
    icon: (
      <>
  ...
  },
  {
    ...
    description:
      "Availability is presented through responsible confidence signals, not unsafe public inventory quantities.",
    icon: (
      <path
        d="M3 8.5l3 3 7-7"
        stroke="currentColor"
...
export default function PatientPortalTrustSafetySection() {
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <Reveal index={1} active={mounted}>
          <h2 className="text-[2rem] font-extrabold leading-tight sm:text-[2.3rem]">
            <span className="text-[#0F1F4E]">A patient account with </span>
  ...
  return (
    <div
      style={{
        ...
        animation: active ? `patientPortalTrustSafetyFadeUp 0.6s ease-out ${index * 90}ms both` : "none",
      }}
    >
      {children}
      <style>{`
        @keyframes patientPortalTrustSafetyFadeUp {
