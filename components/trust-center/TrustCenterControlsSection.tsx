...
const ROWS = [
  ...
  },
  {
    ...
    promise:
      "Collect only what is needed for search, account preferences, alerts, workflows, security, and governance.",
  ...
  },
  {
    ...
    promise:
      "Role-based access, MFA readiness, encryption, audit logging, secure sessions, bot protection, and secure document routing for protected workflows.",
  ...
  },
  {
    ...
    promise:
      "Enterprise outputs are contract-scoped, jurisdiction-aware, thresholded, aggregated, and access-controlled.",
  ...
  },
  {
    ...
    promise:
      "Identifiable medicine searches, precise locations, PHI, exact stock, internal scores, and sensitive operational data must not flow into general marketing analytics.",
  ...
  },
  {
    ...
    promise:
      "Public policies, disclaimers, controlled medicine rules, privacy materials, and trust copy are versioned and reviewed.",
            ...
            <div className="w-full overflow-x-auto">
              <div className="min-w-[640px]">
                ...
                <div
                  ...
                  style={{
                    gridTemplateColumns: "1.4fr 3fr 1.6fr",
                    backgroundColor: NAVY,
                  }}
                >
                  {["Control Area", "Public Promise", "Detail Route"].map(
                    (col) => (
                      <span
                        key={col}
                ...
                <div className="divide-y divide-[#F0F2F7]">
                  {ROWS.map((row) => (
                    <div
                      key={row.area}
                      className="grid items-center gap-4 px-6 py-5 transition-colors duration-150 hover:bg-[#F8FAFC] sm:px-8"
                      style={{ gridTemplateColumns: "1.4fr 3fr 1.6fr" }}
                    >
                      {/* Control area */}
  ...
  return (
    <div
      style={{
        ...
        animation: active
          ? `trustControlsFadeUp 0.6s ease-out ${index * 90}ms both`
          : "none",
      }}
    >
      {children}
