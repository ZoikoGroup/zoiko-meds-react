...
const AUDIENCE_CARDS = [
  {
    title: "Trust Pack",
    description:
      "Enterprise buyers, public-sector stakeholders, legal teams, procurement teams, and strategic partners.",
    cta: "Request Trust Pack",
    filled: true,
    icon: (
      <>
        <path
          d="M4 1.5h6l2.5 2.5V14a.5.5 0 01-.5.5H4a.5.5 0 01-.5-.5v-12a.5.5 0 01.5-.5z"
          stroke="currentColor"
          strokeWidth="1.4"
  ...
  },
  {
    title: "Security Pack",
    description:
      "CISOs, security reviewers, IT teams, API buyers, and health-system security teams.",
  ...
  },
  {
    ...
    description:
      "Privacy teams, legal teams, health systems, governments, and data buyers.",
  ...
  },
  {
    ...
    description:
      "Government, public health, emergency preparedness, and jurisdiction-level stakeholders.",
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <Reveal index={1} active={mounted}>
          <h2 className="text-[2rem] font-extrabold leading-tight text-white sm:text-[2.3rem]">
            ...
            <span style={{ color: ACCENT }}>right workflow.</span>
          </h2>
        </Reveal>
        ...
        <Reveal index={2} active={mounted}>
          <p className="mt-4 max-w-xl text-[14px] leading-relaxed text-white/50">
            Gated trust materials are provided after verification, role review,
            or contract scope.
          </p>
        </Reveal>
            ...
            <Reveal key={card.title} index={3 + i} active={mounted}>
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor: "rgba(15,170,135,0.15)",
                    color: ACCENT,
                  }}
                >
        ...
        <Reveal index={7} active={mounted}>
          <div
            id="trust"
            className="mt-10 rounded-2xl bg-white p-6 shadow-[0_4px_24px_-10px_rgba(0,0,0,0.35)] sm:p-8"
          >
            <h3 className="text-[16px] font-bold text-[#0F1F4E]">
              Request Trust Pack
            </h3>
            <p className="mt-1.5 max-w-xl text-[13px] leading-relaxed text-[#5B6478]">
              We route your request to the right trust, security, privacy,
        ...
        <Reveal index={8} active={mounted}>
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-lg text-[13.5px] leading-relaxed text-white/50">
              Review ZoikoMeds privacy, security, verification, availability
              confidence, controlled medicine, accessibility, and enterprise
  ...
  return (
    <div
      style={{
        ...
        animation: active
          ? `trustAccessFadeUp 0.6s ease-out ${index * 90}ms both`
          : "none",
      }}
    >
      {children}
