...
export default function ProviderOverviewCtaSection() {
          ...
          <div className="relative z-10 flex flex-col items-center gap-5">
            ...
            <Reveal index={0} active={mounted}>
              <h2 className="mx-auto max-w-2xl text-xl font-bold leading-snug text-white sm:text-[1.7rem]">
                Support patients with clearer medicine availability next steps.
              </h2>
            </Reveal>
            ...
            <Reveal index={1} active={mounted}>
              <p className="mx-auto max-w-md text-[14px] leading-relaxed text-[#8FA3C8]">
                Use ZoikoMeds to help patients and caregivers understand
                availability signals, confirm with pharmacies, and return when
                signals change.
              </p>
            </Reveal>
  ...
  return (
    <div
      style={{
        ...
        animation: active
          ? `providerCtaFadeUp 0.55s ease-out ${index * 110}ms both`
          : "none",
      }}
    >
      {children}
