...
const TABS: StakeholderTab[] = [
  {
    ...
    features:
      "Availability intelligence, shortage signals, reports, regional analytics.",
    value:
      "Medicine access visibility, operational planning, patient support workflows.",
  ...
  },
  {
    label: "Pharmacies",
    features:
      "Confirmation coverage, demand signals, network status, restock timing.",
    value:
      "Fewer stockouts, faster substitution decisions, clearer patient communication.",
  ...
  },
  {
    ...
    features:
      "Aggregated demand curves, regional pressure mapping, partner-level reporting.",
    value:
      "Sharper allocation decisions without exposing sensitive inventory data.",
  ...
  },
  {
    label: "Manufacturers",
    features:
      "Regional access trends, shortage movement history, market signal exports.",
    value:
      "Earlier visibility into access gaps and demand shifts across regions.",
  ...
  },
  {
    ...
    features:
      "Aggregated access signals, shortage monitoring, exportable summary reports.",
    value:
      "Early warning on potential access concerns across populations and regions.",
  ...
  },
  {
    ...
    features:
      "Role-based dashboards, saved views, audit-ready exports, API access.",
    value:
      "Governed analytics that plug directly into existing internal workflows.",
