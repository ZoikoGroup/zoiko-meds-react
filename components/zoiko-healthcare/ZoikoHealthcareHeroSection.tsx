...
export default function ZoikoHealthcareHeroSection() {
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {mounted ? (
          <Reveal index={0}>
            <nav className="mb-6 flex items-center gap-2 text-[12.5px] text-[#8891A4]">
              ...
              <span>/</span>
              <a href="/trust-center" className="transition-colors duration-200 hover:text-[#0F1F4E]">
                Trust &amp; Legal
              </a>
              <span>/</span>
        ...
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="flex flex-col gap-5">
                ...
                <Reveal index={2}>
                  <h1 className="font-[var(--font-plus-jakarta-sans)] text-4xl font-bold leading-[1.15] text-[#0F1F4E] sm:text-[2.65rem]">
                    ...
                    <br />
                    behind <span style={{ color: ACCENT }}>ZoikoMeds.</span>
                  </h1>
                </Reveal>
          ...
          <div>
            {mounted ? (
              <div
                className="animate-[zoikoSignalFadeUp_0.65s_ease-out_forwards] overflow-hidden rounded-2xl  transition-shadow duration-300 hover:shadow-[0_20px_48px_-16px_rgba(15,31,78,0.24)]"
                style={{ opacity: 0, animationDelay: "150ms" }}
              >
                {/* TODO: replace src with your final image URL */}
                <img
                  src="/images/Healthcare-banner.webp/"
                  alt="Zoiko Healthcare"
