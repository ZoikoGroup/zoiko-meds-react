          ...
          <div className="flex flex-col">
            ...
            <Reveal index={1} active={mounted}>
              <h1 className="text-[2.2rem] font-extrabold leading-[1.13] tracking-tight text-[#0F1F4E] sm:text-[2.6rem]">
                ...
                <span style={{ color: ACCENT }}>
                  search without creating clinical risk.
                </span>
              </h1>
            </Reveal>
            ...
            <Reveal index={2} active={mounted}>
              <p className="mt-5 text-[14.5px] leading-relaxed text-[#5B6478]">
                ...
                caregivers to availability signals, pharmacy confirmation, saved
                searches, and alerts — without replacing prescriptions, clinical
                judgment, dispensing decisions, or direct pharmacy confirmation.
              </p>
            </Reveal>
            ...
            <Reveal index={5} active={mounted}>
              <p className="mt-5 flex items-start gap-2 text-[12.5px] leading-relaxed text-[#5B6478]">
                <InfoIcon />
                <span>
                  ZoikoMeds referral guidance is an availability handoff, not a
                  medical referral, prescription change, clinical
          ...
          <div className="flex justify-center lg:justify-end">
            <Reveal index={2} active={mounted}>
              {mounted ? (
                <img
                  src="/refer/hero.png"
                  alt="Referral Guidance Interface Preview"
  ...
  return (
    <div
      style={{
        ...
        animation: active
          ? `refHeroFadeUp 0.6s ease-out ${index * 90}ms both`
          : "none",
      }}
    >
      {children}
