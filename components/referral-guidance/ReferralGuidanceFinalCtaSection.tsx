...
export default function ReferralGuidanceFinalCtaSection() {
            ...
            <>
              <Reveal index={0}>
                <h2 className="font-[var(--font-plus-jakarta-sans)] text-2xl font-bold leading-tight text-white sm:text-[1.85rem]">
                  Give patients clearer availability guidance after the
                  visit.
                </h2>
              </Reveal>
              ...
              <Reveal index={1}>
                <p className="mx-auto mt-4 max-w-xl text-[14px] leading-relaxed text-[#A9B2C8]">
                  Use ZoikoMeds referral guidance to direct patients and
                  caregivers toward medicine availability search,
                  pharmacy confirmation, saved searches, and alerts —
...
function Reveal({
  ...
  return (
    <div
      className="animate-[referralFinalCtaFadeUp_0.6s_ease-out_forwards]"
      style={{ opacity: 0, animationDelay: `${index * 100}ms` }}
    >
      {children}
      <style jsx>{`
        @keyframes referralFinalCtaFadeUp {
          from {
            opacity: 0;
