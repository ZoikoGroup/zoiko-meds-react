      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        ...
        <div>
          {mounted ? (
            <div className="flex flex-col gap-5">
              ...
              <Reveal index={1}>
                <h1 className="font-[var(--font-plus-jakarta-sans)] text-4xl font-bold leading-[1.15] text-[#0F1F4E] sm:text-[38px]">
              ...
              <Reveal index={2}>
                <p className="max-w-lg text-[15px] leading-relaxed text-[#5B6478]">
                  ZoikoMeds helps authorized care teams guide patients through
                  availability signals, pharmacy confirmation steps, saved
                  searches, and alerts — with role-based access, privacy
                  controls, and clear clinical boundaries.
                </p>
              </Reveal>
              ...
              <Reveal index={5}>
                <p className="mt-1 flex max-w-lg items-start gap-2.5 text-[12.5px] leading-relaxed text-[#8891A4]">
                  ...
                  Care team access supports availability guidance. It does not
                  prescribe, dispense, recommend substitutions, validate
                  prescriptions, store medical records by default, or guarantee
                  stock.
                </p>
              </Reveal>
            </div>
        ...
        <div className="flex justify-center lg:justify-end">
          {mounted ? (
            <Reveal index={3}>
              <img
                src="/careteam/hero.png"
                alt="Care Team Access Workspace Preview"
