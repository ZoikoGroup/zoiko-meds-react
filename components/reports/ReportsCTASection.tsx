...
/**
 * ReportsCTASection
 * Closing call-to-action: "Turn medicine availability intelligence
 * into board-ready reports."
 *
 * Layout: dark navy rounded card, centered content, headline
 *         (white + teal), subtext, two buttons (filled + outline),
 *         and a compliance footnote.
 *
...
export default function ReportsCTASection() {
          ...
          >
            ...
            <div className="relative">
              <h2 className="mx-auto max-w-2xl text-[1.65rem] font-extrabold leading-tight text-white sm:text-[2rem]">
                Turn medicine availability intelligence into{" "}
                <span style={{ color: ACCENT }}>board-ready reports.</span>
              </h2>

              <p className="mx-auto mt-4 max-w-xl text-[13.5px] leading-relaxed text-white/55">
                Request sample reports or a briefing to see how ZoikoMeds packages
                availability, shortage, network, regional, and compliance intelligence
                for your teams.
              </p>
              ...
              <p className="mx-auto mt-6 max-w-lg text-[11.5px] leading-relaxed text-white/35">
                Operational intelligence only. ZoikoMeds does not sell, prescribe,
                dispense, deliver, or provide medical advice, and does not expose
                exact inventory quantities to unauthorized users.
              </p>
            </div>
          </div>
        </Reveal>
